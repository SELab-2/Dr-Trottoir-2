...
class Visit(models.Model):
    ...
    building_in_tour = models.ForeignKey(BuildingInTour, verbose_name="id of building", on_delete=models.CASCADE)
    ...
    def __str__(self):
        return f"{self.user.first_name}, {self.building.building.nickname}: {self.arrival}"
