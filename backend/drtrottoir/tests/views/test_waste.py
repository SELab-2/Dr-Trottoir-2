...
from drtrottoir.tests.factories import WasteFactory, DeveloperUserFactory, SuperAdminUserFactory, SuperStudentUserFactory, OwnerUserFactory, StudentUserFactory, BuildingFactory
